<template>
  <div class="location-list">
    ...
    <el-card class="search-card">
      <el-form :inline="true" :model="queryForm" class="search-form">
        <el-form-item label="位置名称">
          <el-input v-model="queryForm.locationName" placeholder="请输入位置名称" clearable />
        </el-form-item>
        <el-form-item label="位置编码">
          <el-input v-model="queryForm.locationCode" placeholder="请输入位置编码" clearable />
        </el-form-item>
    ...
    >
      ...
      >
        ...
        <el-form-item label="位置编码" prop="locationCode">
          <el-input v-model="formData.locationCode" placeholder="请输入位置编码" />
        </el-form-item>
    ...
    <!-- 详情弹窗 -->
    <el-dialog v-model="detailVisible" title="位置详情" width="500px">
      <el-descriptions :column="1" border>
        <el-descriptions-item label="位置 ID">{{ detailData.id }}</el-descriptions-item>
        <el-descriptions-item label="位置名称">{{ detailData.locationName }}</el-descriptions-item>
        <el-descriptions-item label="位置编码">{{ detailData.locationCode }}</el-descriptions-item>
        <el-descriptions-item label="层级">
          <el-tag :type="getLevelType(detailData.level)" size="small">
            {{ getLevelText(detailData.level) }}
          </el-tag>
        </el-descriptions-item>
        <el-descriptions-item label="父级位置">{{ detailData.parentName || '无' }}</el-descriptions-item>
...
const buildTreeOptions = (list) => {
  ...
  list.forEach(item => {
    map[item.id] = { ...item, label: item.locationName, value: item.id, children: [] }
  })
